migrate(
  (app) => {
    ...
    app
      .db()
      .newQuery(
        "UPDATE patients SET journey_stage = 'pedido_exames_enviados' WHERE journey_stage = 'exames_enviados'",
      )
      .execute()
    ...
    app
      .db()
      .newQuery(
        "UPDATE patient_stage_history SET stage = 'pedido_exames_enviados' WHERE stage = 'exames_enviados'",
      )
      .execute()
  ...
  (app) => {
    ...
    app
      .db()
      .newQuery(
        "UPDATE patients SET journey_stage = 'exames_enviados' WHERE journey_stage = 'pedido_exames_enviados'",
      )
      .execute()
    ...
    app
      .db()
      .newQuery(
        "UPDATE patient_stage_history SET stage = 'exames_enviados' WHERE stage = 'pedido_exames_enviados'",
      )
      .execute()
